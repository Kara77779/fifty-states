...
> This is Cara Li's fork of the [ALARM Project's upstream repository](https://github.com/alarm-redist/fifty-states). See [Cara's contribution record](CARA_CONTRIBUTIONS.md), including the merged [South Carolina legislative analysis](https://github.com/alarm-redist/fifty-states/pull/267).
